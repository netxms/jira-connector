...
Downloaded from http://www.darkside.com.au/ice/index.html

"The ICE algorithm is public domain, and source code can be downloaded from this page.
There are no patents or copyrights, so its use is unrestricted."

No changed were introduced to this file except package name and automatic code reformat.
